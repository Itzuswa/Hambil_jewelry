...
export default function Ring_Page2() {
   ...
   return (<>
      ...
      <div className="pagination">
         <div><Link className="page-link" to={'/rings/ring1'}> <i className="fa-solid fa-angle-left arrow-left"></i></Link></div>
         ...
         <div><Link className="page-link" to={'/rings/ring3'}><i className="fa-solid fa-angle-right arrow-right"></i></Link></div>
      </div >
   </>)
}