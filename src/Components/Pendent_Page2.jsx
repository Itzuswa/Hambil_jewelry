...
const imageList = Object.values(images).map((m) => m.default).slice(9, 18);

export default function Pendent_Page2() {
   ...
   return (<>
      ...
      <div className="pagination">
         ...
         <div style={{ borderBottom: ' 2px solid white' }}><Link className="page-link" to={'/pendants/page2'}>2</Link></div>
         <div><Link className="page-link" to={'/pendants/page3'}>3</Link></div>
         <div><Link className="page-link" to={'/pendants/page4'}>4</Link></div>
         <div><Link className="page-link" to={'/pendants/page3'}><i className="fa-solid fa-angle-right arrow-right"></i></Link></div>
      </div >
   </>);
}
