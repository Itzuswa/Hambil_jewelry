...
const imageList = Object.values(images).map((m) => m.default).slice(27);

export default function Pendent_Page4() {
   ...
   return (<>
      ...
      <div className="pagination">
         ...
         <div><Link className="page-link" to={'/pendants/page3'}> <i className="fa-solid fa-angle-left arrow-left"></i></Link></div>
         ...
         <div style={{ borderBottom : ' 2px solid white' }}><Link className="page-link" to={'/pendants/page4'} >4</Link></div>
      </div >
   </>);
}
